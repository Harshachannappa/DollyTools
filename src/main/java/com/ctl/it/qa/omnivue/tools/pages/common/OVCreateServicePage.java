...
public class OVCreateServicePage extends OmniVuePage {
	...
	// ---------------------------DSL OVC Service Webelements starts
	// here----------------------------------------------------

	@FindBy(xpath = "(//input[@id='NAME'])[2]")
	public WebElementFacade tbx_Name;

	@FindBy(xpath = "(//input[@id='ALIAS1'])[2]")
	public WebElementFacade tbx_Alias1;

	@FindBy(xpath = "(//input[@id='ALIAS2'])[2]")
	public WebElementFacade tbx_Alias2;

	@FindBy(xpath = "(//textarea[@id='DESCRIPTION'])[2]")
	public WebElementFacade tbx_Note;

	@FindBy(xpath = "(//img[@src='../images/viewTask.png'])[1]")
	public WebElementFacade img_Subscribername;

	// ----------------------------Subscriber Look Up starts
	// here-----------------------------------
	@FindBy(xpath = "//label[text()='Subscriber Name %']/following-sibling::input")
	public WebElementFacade tbx_lookUp_SubscriberName;
	...
	@FindBy(xpath = "//select[@id='PROTOCOL_TYPE']")
	public WebElementFacade ddl_NetworkProtocol;

	@FindBy(xpath = "//select[@id='IPVERSION']")
	public WebElementFacade ddl_SupportedIPVersion;

	@FindBy(xpath = "//select[@id='USAGE']")
	public WebElementFacade ddl_UsageType;

	@FindBy(xpath = "(//img[@src='../images/viewTask.png'])[2]")
	public WebElementFacade img_DSLMPathName;

	@FindBy(xpath = "(//img[@src='../images/viewTask.png'])[3]")
	public WebElementFacade img_BRASPathName;

	@FindBy(xpath = "//span[label[text()='Circuit Name %']]/span/following-sibling::input")
	public WebElementFacade img_CircuitName;

	@FindBy(xpath = "(//input[@value='LookUp'])[2]")
	public WebElementFacade btn_CircuitLookUp;

	@FindBy(xpath = ".//*[@id='Circuit_look_up']/tbody/tr/td[1]/a")
	public WebElementFacade lnk_CircuitName;

	@FindBy(xpath = "//input[@id='VLANVPN']")
	public WebElementFacade tbx_DSLM_VLAN_VPN;

	@FindBy(xpath = "//select[@id='SERVICENAME']")
	public WebElementFacade ddl_ServiceName;

	@FindBy(xpath = ".//*[@id='0']/ng-include/div/div[6]/div[3]/div[1]/label[1]/input")
	public WebElementFacade cbx_Auto_Activate;

	@FindBy(xpath = "//input[@value='Create']")
	public WebElementFacade btn_create;

	// ----------------------------Subscriber Look Up ends
	// here-----------------------------------

	// ---------------------------DSL OVC Service Webelements ends
	// here------------------------------------------------------
